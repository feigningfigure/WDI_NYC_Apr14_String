...
get "/students" do
  ...
  # $students.to_s
    ...
    # pretty_student_printer($students[1])+
    # pretty_student_printer($students[2])+
    # pretty_student_printer($students[3])
    

  $stzudents.each_index {|index| pretty_student_printer($students[index])+}
