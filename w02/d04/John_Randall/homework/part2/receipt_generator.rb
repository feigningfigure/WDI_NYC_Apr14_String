...
class Receipt_maker
  ...
  def initialize (company_name = "Particular Assembly Inc.", thank_you_msg_single = "Thank you! Goonies Never say die!", thank_you_msg_multiple = "Thanks you for all of your business.<br> 'This one is my wish, and I'm taking it back.'")
