...
var CarView = Backbone.View.extend({
  ...
  render: function(){
    this.$el.html( this.template({ car: this.model.toJSON() }) );  // same as this.model.attributes
...
// collection only needs to know what it is a collection for
...
$(function(){
  ...
  honda = new Car({ make: "Honda" , type: "Accord", color: "Black" });
  toyota = new Car({ make: "Toyota" , type: "Corolla", color: "Red" });
  ford = new Car({ make: "Ford" , type: "Fiesta", color: "Yellow" });
  buick = new Car({ make: "Buick" , type: "Le Sabre", color: "Gray" });
...
// you can use car.attributes to 'see' the model
// you can car.set({}) to change attributes of data.
