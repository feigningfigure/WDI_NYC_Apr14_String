...
Cupcakeapp.Views.CupcakeView = Backbone.View.extend({
  ...
  editTemplate: _.template( $('#cupcake-edit-template').html() ),
  events: {
    'click [data-action="destroy"]' : 'destroyCupcake',
