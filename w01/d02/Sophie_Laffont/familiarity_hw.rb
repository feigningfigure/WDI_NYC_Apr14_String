...
# ADDS THIS SECOND ARRAY AT THE END OF THE ARRAY, AND ONLY IN ONE SHELF OF THE ARRAY

number_array.flatten!
# ADDS THE SECOND ARRAY AS PART OF THE FIRST ARRAY AT THE END OF THE FIRST ARRAY
