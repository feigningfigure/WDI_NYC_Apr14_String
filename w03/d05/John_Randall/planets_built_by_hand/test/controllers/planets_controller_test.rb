...
class PlanetsControllerTest < ActionController::TestCase
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post :create, planet: { diameter: @planet.diameter, image_url: @planet.image_url, life: @planet.life, mass: @planet.mass, name: @planet.name }
    end
  ...
  test "should update planet" do
    patch :update, id: @planet, planet: { diameter: @planet.diameter, image_url: @planet.image_url, life: @planet.life, mass: @planet.mass, name: @planet.name }
    assert_redirected_to planet_path(assigns(:planet))
  end
